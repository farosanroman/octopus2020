...
// you'll often use just a few of them.
  ...
  function GeoCalendar(props) {
    ...
    useEffect(() => {
        fetchData("https://octopustestingfunctions.azurewebsites.net/api/GetGroupByDatesKPICaracas?code=F3Rb8pR03YSXi0fPEtprJ6GHQgEO5VLnc3aF6tvv/9pccdpaXSFwhg==")
...
//const GeoCalendar = ({ data /* see data tab */ }) => (
